...
const SettlementPage = ({ isGuest, isOwner, showModal, commentRefreshKey, handleCompleteSettlement, handleReactivateSettlement }) => {
  ...
  }, [settlementId, loadSettlementData]);

  useEffect(() => {
    if (!isDataLoaded || !settlementId || isGuest || isArchived) return;
  ...
  }, [isDataLoaded, title, subtitle, participants, expenses, personalDeductionItems, settlementId, isGuest, isArchived]);
    ...
    <>
      ...
      <main>
        <ExpenseTable
          ...
          onCompleteSettlement={() => handleCompleteSettlement(settlementId, { title, subtitle, participants, expenses, personalDeductionItems })}
